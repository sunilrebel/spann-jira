...
exports.addJiraList = function (key, jiraList) {
    totalData.queryDetail[key] = {jiraList: jiraList};
};

exports.addJiraData = function (key, extractedData) {
    if (!totalData.queryDetail[key]) {
        totalData.queryDetail[key] = {
            jiraDetail: []
        }
    } else if (!totalData.queryDetail[key]["jiraDetail"]) {
        totalData.queryDetail[key]["jiraDetail"] = [];
    }
    totalData.queryDetail[key]["jiraDetail"].push(extractedData);
};
