...
// todo check if the page scanning is complete, if yes then add reload button else process button
// todo add export button click event
// todo create a separate loop controller which will take jiralist & base url as input
// todo process only numberOfJiraTogether that are coming from UI based on settings
// todo add process in selection functionality in input & on right click
// todo add comma separated jiraBaseURL functionality
// todo add regex functionality & field higlighter functionality on UI
// todo add credits in plugin