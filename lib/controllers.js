                ...
                if (exports.isGarbageContent(params.data)) {
                    if (baseUrl) {
                        ...
                        if ( jiraList && jiraList.length > 0) {
                            ...
                            exports.errorController('show', {msg: 'There was no Jira ID found.'});
                        }

                    } else {
                        exports.errorController('show', {msg: 'Base Jira Url is not defined.'});
                    }
                }
...
exports.errorController = function(message, params) {
    switch (message) {
        case 'show' :
            var tabs = require('sdk/tabs');
            tabs.activeTab.attach({
                contentScript: 'alert("SpannJira: '+params.msg+'")'
            });
            break;
    }
};
